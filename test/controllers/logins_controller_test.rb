...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { clave: @login.clave, nombre_usuario: @login.nombre_usuario } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { clave: @login.clave, nombre_usuario: @login.nombre_usuario } }
