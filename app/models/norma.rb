...
class Norma < ActiveRecord::Base
  ...
  validates_presence_of(:tipo_norma_id, :message => "¡Debe escojer un tipo de norma!")

  validates_presence_of(:sumario, :message => "¡Debe escribir un sumario!")
  ...
  validates_presence_of(:lugar_publicacion, :message => "¡Debe escojer un lugar de publicacion!")

  #¿es necesario las validaciones estas?
  #NOP... Pues se utiliza un tipo de listado para buscarlos...
  # Igualmente sería útil para evitar un POST inadecuado y hacer que la base de datos
  ...
  #Valida que el campo Lugar_publicacion sea una entrada de la tabla "lugar_publicacion"
  ...
  validates_uniqueness_of(:numero, :scope => [:tipo_norma_id], :message => "¡Ese número de norma ya existe!")
  ...
  #
  def Norma::asignar_estado(estado_id, comentario, norma, causa_cambio_estado = nil)
    ...
    if (cc.nil?)
      ...
      cc = CausaCambioEstado.find(:first, :conditions => ["nombre = ?", CausaCambioEstado::AplicadoPorUsuario])
      if (cc.nil?)
  ...
  #
  # Ejemplo:
  #     Norma.agregar_otras_opciones(["instr(texto,?)", "hola"], {:estado_id => 1, :tipo_norma_id => 2})
  #
  # Devulve:
  #     ["instr(texto,?)  AND (
  ...
  # Devuelve un string con el orden con el que se debe ordenar los resultados de una búsqueda.
  # La salida tiene un formato SQL, ejemplos:
  #   "numero ASC"
  #   "fecha_sancion ASC"
  #
  #   [+orden+] Un Hash que posee uno de los siguientes tipos, y va al string ASC o DESC.
  #     :numero
  #     :fecha_sancion
  #     :fecha_publicacion
  #     :fecha_promulgacion
  ...
  #   [+Norma::Tipo_fecha_sancion+]       Busca las normas dentro del rango en la fecha de sanción
  #   [+Norma::Tipo_fecha_promulgacion+]  Busca las normas dentro del rango en la fecha de promulgación
  #   [+Norma::Tipo_fecha_publicacion+]   Busca las normas dentro del rango en la fecha de publicación
  #
  # Otras opciones es un hash con valores que pueden ser:
  #   [+:estado_id+]      El id del estado con el cual limitar la búsqueda.
  #   [+:tipo_norma_id+]  El id del tipo de norma con el cual limitar la búsqueda.
  #   [+:general+]        True si buscar normas de tipo general solamente,
  #                       false si buscar sólo los particulares. Si no está(o es nil)
  #                       se buscará tanto particulares como generales.
  #
  # La opción +orden+ permite devolver en un orden determinado los resultados. Es un hash de un sólo
  ...
  #   :fecha_promulgacion => ...
  #   :creado => ...
  def Norma::buscar_por_fecha(fecha_desde, fecha_hasta, tipo_fecha, otras_opciones = {}, orden = {})
  ...
  # Busca una serie de normas según el número, o según una parte del número de la norma
  # Opcionalmente se puede buscar también el tipo de norma, el estado y si es particular
  # o general.
  #
  # _Ejemplo:_
  #
  ...
  #   [+:texto+]            Devuelve las normas que encuentre +texto+ en sus textos.
  #   [+:sumario+]          Devuelve las normas que encuentre +texto+ en sus sumarios.
  #   [+:citas_doctorales+] Devuelve las normas que encuentre +texto+ en sus citas_doctorales.
  #   [+:cituas_juris+]     Devuelve las normas que encuentre +texto+ en sus citas jurisprudenciales.
  #   [+:comentario+]       Devuelve las normas que encuentre +texto+ en sus comentarios.
  #
  # Ejemplo:
  ...
  # Si +desc_part_id+ está presente, entonces busca las normas que posean ese descriptor particular.
  # Si +desc_part_id+ no está presente sólo busca las que poseen el descriptor general con id +desc_gen_id+.
  #
  ...
  #   :fecha_promulgacion => ...
  #   :creado => ...
  def Norma::buscar_por_descriptor(desc_gen_id, desc_part_id = nil, otras_opciones = {}, orden = {})
    unless (desc_part_id.nil? or desc_part_id.empty?)
      #Eligió un descriptor particular... buscar por descriptor particular solamente.
      condiciones = ["descriptor_particular_id = ? AND normas.id = posee_desc_parts.norma_id", desc_part_id]
      ...
      #No eligió un desc. particular... buscar por el descriptor general solamente.
      condiciones = ["descriptor_general_id = ? AND normas.id = posee_descriptors.norma_id",desc_gen_id]
  ...
  # Elimina la norma y <b>todos los registros necesarios</b> en la base de datos.
  ...
  #    * Entre la norma y Cambios de estados(y sus cambios aplicados)(_cambio_estado_ y _cambio_aplicado_).
  ...
  # (según lo indica los diagramas MER y los modelos de base de datos realizados).
  #
