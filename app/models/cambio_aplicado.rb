...
class CambioAplicado < ApplicationRecord
  ...
  validates_presence_of :fecha_aplicado,
                        :message => "¡Debe haber una fecha de aplicado!"
  validates_presence_of :cambio_estado_id,
                        :message => "¡Debe haber un cambio de estado!"
  ...
  #   * CambioAplicado::PorFechaAplicado: Según la fecha en que el cambio
  #     se aplicó.
  #   * CambioAplicado::PorFechaCambio: Según la fecha en que se planificó
  #     el cambio
  #   * CambioAplicado::PorFechaCreacion: Según la fecha en que se creó la
  #     planificación.
