...
class CambioEstado < ActiveRecord::Base
  #Privilegios:
  ...
  validates_uniqueness_of :norma_id, :scope => [:fecha_cambio], :message => "¡Esa fecha de cambio para esa norma ya existe!"
  validates_presence_of :fecha_cambio, :message => "¡Debe ingresar una fecha de cambio!"
  validates_presence_of :norma_id, :message => "¡Debe asignar una norma a este cambio de estado!"
  #¡deben estar también el estado y la causa!
  validates_presence_of :estado_id, :message => "¡Debe elegir un estado!"
  validates_presence_of :causa_cambio_estado_id, :message => "¡Debe elegir una causa de cambio de estado!"
