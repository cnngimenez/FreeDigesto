...
class PoseeDescriptor < ActiveRecord::Base
  #Privilegios:
  ...
  validates_presence_of(:descriptor_general, :message => "¡Debe seleccionar un descriptor general válido")
  ...
  validates_uniqueness_of(:norma_id, :scope => [:descriptor_general_id],
    :message => "¡Sólo una norma con un descriptor!")

  # Elimino todas las tuplas de mi tabla(_posee_descriptor_) que estén relacionadas con
