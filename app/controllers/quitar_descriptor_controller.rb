...
class QuitarDescriptorController < ApplicationController
  ...
  def quitar_desc_part
    if not verificar_privilegios(PoseeDescPart::PuedeEliminar)
      ...
      if error == ""
        ...
        flash[:notice] = "¡Hubo problemas al quitar los "+
                         "\"posee_descriptor\": " + error
      end
  ...
  # Borra una relación entre norma y descriptor general(posee_descriptor) y
  # todas las relaciones de sus descriptores particulares con esta
  # norma (posee_desc_parts)
  #
